...
const socialLinks = [
  {
    label: "Instagram",
    url: "https://www.instagram.com/abbiwoods",
    icon: (
  ...
  {
    label: "TikTok",
    url: "https://www.tiktok.com/@woodswrld",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "Spotify",
    url: "https://open.spotify.com/artist/44GFA4EspGPaCQo4VqLzTR?si=q5rGnXfjQJaASskAf4foyQ",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
